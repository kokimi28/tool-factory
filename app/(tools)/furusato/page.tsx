...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "本サイトの年収概算は、社会保険料を年収の約14.715%とみなし、基礎控除・配偶者控除・扶養控除のみを考慮した簡易計算です。医療費控除・住宅ローン控除・iDeCo（小規模企業共済等掛金控除）などがあると課税所得が下がり、限度額も下がります。正確に出すには住民税決定通知書の課税総所得金額を「課税所得から正確に」タブに入力してください。",
  },
  {
...
export default function FurusatoPage() {
  return (
    <>
      ...
      <LawBasis basis="計算式の根拠：総務省ふるさと納税ポータルサイト（控除額の計算）／地方税法第37条の2・第314条の7。" checkedAt={SITE_META.lastUpdated} />
    </>
  );
}
