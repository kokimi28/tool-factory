...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: `所得税法第30条、所得税法施行令第69条・第70条・第72条、国税庁タックスアンサー No.1420・No.2732・No.2735、退職所得の源泉徴収税額の速算表に基づき、2026年1月1日（令和8年1月1日）施行の法令で計算しています（最終確認日：${SITE_META.lastUpdated}）。ただしあくまで参考値であり、年金受取との併用や短期勤続の特例など複雑なケースは扱いません。該当する場合は税理士へご相談ください。`,
  },
];
        ...
        <header className="bg-white border-b border-gray-200">
          <div className="max-w-3xl mx-auto px-4 py-6">
            ...
            <p className="text-xs text-gray-500 mt-2">
              適用法令：{SITE_META.appliedLawDate}施行（2026年1月1日／10年ルール対応）・最終確認日 {SITE_META.lastUpdated}
            </p>
          </div>
        </header>
