...
import { ARTICLES, getArticle } from '@/lib/ideco/articles';
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/ideco/articles/${article.slug}` },
    openGraph: {
      title: article.title,
      description: article.description,
      type: 'article',
        ...
        <article className="max-w-3xl mx-auto bg-white border border-gray-200 rounded-lg p-6 space-y-8 text-sm text-gray-800 leading-relaxed">
          ...
          <section className="rounded-lg bg-blue-50 border border-blue-100 p-4">
            <p className="text-gray-800">
              ...
              <Link href="/ideco" className="text-blue-600 hover:underline font-medium">
                iDeCo受取税シミュレーター
              </Link>
